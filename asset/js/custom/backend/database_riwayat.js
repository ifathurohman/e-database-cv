...
var table;
var url_list           = host + "database_riwayat-list";
var url_edit           = host + "database_riwayat-edit";
var url_delete         = host + "database_riwayat-active";
var url_save           = host + "database_riwayat-save";
var url_export         = host + "database_riwayat-export";
var url_save_import    = host + "database_riwayat-save-import";
var url_save_import2   = host + "database_riwayat-save-import2";

// var url_save_import2   = host + "database_pengalaman-save-import";
...
function result_impot2(data){
    xform = '#form-import';
    $(xform+' #inputFileName').val(data.inputFileName);
    $(xform+' #CompanyID').val(data.CompanyID);
    $('.v-import-result2').show(300);
    // if ( $.fn.DataTable.isDataTable('#table-import-result') ) {
    //     import_header(data.header);
    //     $('#table-import-result').DataTable().destroy();
    // }
    $('#table-import-result2 thead').empty();
    $('#table-import-result2 tbody').empty();
    $('.import-total-succeess').empty();
    $('.import-total-failed').empty();
    $('.import-total').empty();

    import_header2(data.header2);

    $('html, body').animate({
        scrollTop : $('#table-import-result2').offset().top - 100
    }, 1000);
    item = '';
    total_import_success = 0;
    total_import_failed  = 0;
    ...
    $('#table-import-result2 tbody').append(item);
    // $('#table-import-result').DataTable({
    //     "destroy"   : true,
    // });
    $('.import-total-succeess').text(total_import_success);
