...
var table;
var url_list            = host + "output_pendidikan-list";
var url_edit            = host + "output_pendidikan-edit";
var url_delete          = host + "output_pendidikan-active";
var url_delete_all      = host + "output_pendidikan-active_all";
var url_save            = host + "output_pendidikan-save";
var url_export          = host + "output_pendidikan-export";
var url_save_import     = host + "output_pendidikan-save-import";
...
$("#table-list tbody").on('click','tr td:not(:first-child)',function(event){
    ...
    val = {status:'1',id:td}
    // val = $('#table-list tbody tr td:first-child').children().attr('data-id');
    // console.log(td)
    short_click(val);
});
...
//     $('.action_list').removeClass('active');
//     $('#table-list-non tbody tr td .action_list').eq(index_dt2).addClass("active");
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            if(data.status){
                ...
                $(xform+' [name=Nomor_hp]').val(dt_value.Nomor_hp);
                $(xform+' [name=Email]').val(dt_value.Email);
                $('#Pendidikan1').summernote('code', dt_value.Pendidikan);
                $('#Pendidikan_non_formal1').summernote('code', dt_value.Pendidikan_non_formal);
