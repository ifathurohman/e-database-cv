...
var table;
var url_list    = host + "konstruksi-list";
var url_edit    = host + "konstruksi-edit";
var url_delete  = host + "konstruksi-active";
var url_save    = host + "konstruksi-save";
var url_export  = host + "konstruksi-export";
var url_export_word  = host + "konstruksi-export_word";
var url_save_import = host + "konstruksi-save-import";
...
function collapseCard(e){
    console.log("CO", e.target);
    $(e.target).parents('.collapsed-card').find('.collapsed-target ').toggleClass('collapsed');
    $(e.target).parents('.btn-card-collapse').toggleClass('collapsing');
}
...
function add_pengalaman() {
    ...
    <input type="radio" name="Status_kepegawaian['+ status +']" id="status_kepeg1_tidak_tetap'+ status +'" value="Tidak Tetap" class="form-check-input radio-custom Status_kepegawaian'+ status +'">\
