...
var table;
var url_list        = host + "upload_cv-list";
var url_edit        = host + "upload_cv-edit";
var url_delete      = host + "upload_cv-active";
var url_save        = host + "upload_cv-save";
var url_export      = host + "upload_cv-export";
var url_save_import = host + "upload_cv-save-import";
...
function download() {
    var iframe = document.getElementById('office');
    iframe.src = "https://www.edatabasecv.com/Tamplate/sample word.docx";
}
