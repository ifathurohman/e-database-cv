...
$('#table-list-non tbody').on(
  ...
  function (event) {
    ...
    $('.action_list').removeClass('active');
    $('#table-list-non tbody tr td .action_list')
      .eq(index_dt)
      .addClass('active');
    event.stopPropagation();
  },
...
function action_view() {
  ...
  var encode_dir1 = encodeURIComponent(url_dir)
    .replace(/'/g, '%27')
    .replace(/"/g, '%22');
  var encode_dir1 = encodeURIComponent(encode_dir1)
    .replace(/'/g, '%27')
    .replace(/"/g, '%22');
  var url_file1 =
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data.status) {
        ...
        $(xform + ' [name=Tempat_tanggal_lahir]').val(
          dt_value.Tempat_tanggal_lahir,
        );
        $('#Pendidikan' + riwayat).summernote('code', dt_value.Pendidikan);
        $('#Pendidikan_non_formal' + riwayat).summernote(
          'code',
          dt_value.Pendidikan_non_formal,
        );
...
function add_pengalaman(data) {
  ...
  if (kolom > 1) {
    button_remove =
      '<span class="pointer" onclick="remove_education_fields(' +
      room +
      ')"><i class="fa fa-minus-square-o fa-lg" style="font-weight:500;font-size:32px;margin-right:25px;color:red"></i></span>';
  }
  ...
  divtest.innerHTML =
    '<div class="card" id="pengalaman_kerjax">\
    ...
    <div class="card-body bg-card">\
        ...
        <input type="hidden" name="PengalamanID[]" id="PengalamanID' +
    room +
    '" value="' +
    PengalamanID +
    '">\
        ...
        <div class="col-md-8">\
            ...
            <input class="form-control input-custom total_pengalaman" name="Nama_kegiatan[]" id="Nama_kegiatan' +
    room +
    '" type="text" onclick="modal_pengalaman(' +
    "'#Nama_kegiatan" +
    room +
    "'" +
    ')" placeholder="Masukan nama kegiatan" value="' +
    Nama_kegiatan +
    '">\
            ...
            <input class="form-control input-custom" name="Lokasi_kegiatan[]" id="Lokasi_kegiatan' +
    room +
    '" type="text" placeholder="Masukan lokasi kegiatan" readonly="" value="' +
    Lokasi_kegiatan +
    '">\
            </div>\
            <div class="form-group">\
            <label class="custom-label">PENGGUNA JASA</label>\
            <input class="form-control input-custom" name="Pengguna_jasa[]" id="Pengguna_jasa' +
    room +
    '" type="text" placeholder="Masukan pengguna jasa" readonly="" value="' +
    Pengguna_jasa +
    '">\
            </div>\
            <div class="form-group">\
            <label class="custom-label">NAMA PERUSAHAAN</label>\
            <input class="form-control input-custom" name="Nama_perusahaan[]" id="Nama_perusahaan' +
    room +
    '" type="text" placeholder="Masukan nama perusahaan" readonly="" value="' +
    Nama_perusahaan +
    '">\
            </div>\
            <div class="form-group">\
            <label class="custom-label">POSISI PENUGASAN</label>\
            <input class="form-control input-custom Posisi_penugasan[]" name="Posisi_penugasan[]" id="Posisi_penugasan' +
    room +
    '" type="text" onclick="modal_penugasan(' +
    "'#Posisi_penugasan" +
    room +
    "'" +
    ')" placeholder="Masukan posisi penugasan" value="' +
    Posisi_penugasan +
    '">\
            <small class="form-control-feedback"></small>\
            </div>\
            <div class="form-group">\
                ...
                <textarea class="form-control Uraian_tugas" name="Uraian_tugas[]" id="Uraian_tugas' +
    room +
    '" placeholder="Masukan uraian tugas"></textarea>\
            </div>\
            <div class="form-group">\
            <label class="custom-label">WAKTU PELAKSANAAN</label>\
            <input class="form-control input-custom" name="Waktu_pelaksanaan[]" id="Waktu_pelaksanaan' +
    room +
    '" type="text" placeholder="Masukan waktu penugasan" readonly="" value="' +
    Waktu_pelaksanaan +
    '">\
            </div>\
            <div class="form-group">\
                ...
                <div class="row">\
                    ...
                    <div class="custom-control custom-radio">\
                        <input type="radio" name="Status_kepegawaian[' +
    status +
    ']" id="status_kepeg1_tidak_tetap' +
    status +
    '" value="Tidak Tetap" class="form-check-input radio-custom Status_kepegawaian' +
    room +
    '">\
                    ...
                    <div class="custom-control custom-radio ml-70-px">\
                        <input type="radio" name="Status_kepegawaian[' +
    status +
    ']" id="status_kepeg1_tetap' +
    status +
    '" value="Tetap" class="form-check-input radio-custom Status_kepegawaian' +
    room +
    '">\
            ...
            <input class="form-control input-custom" name="Surat_referensi[]" id="Surat_referensi' +
    room +
    '" type="text" placeholder="Masukan surat referensi dari pengguna jasa" readonly="" value="Terlampir">\
            </div>\
        </div>\
        </div>\
    </div>\
...
function export_word_konstruksi(p1 = '') {
  ...
  Penguasaan_bahasa_indo = $(
    xform + ' [name=Penguasaan_bahasa_indo]:checked',
  ).val();
  Penguasaan_bahasa_inggris = $(
    xform + ' [name=Penguasaan_bahasa_inggris]:checked',
  ).val();
  Penguasaan_bahasa_setempat = $(
    xform + ' [name=Penguasaan_bahasa_setempat]:checked',
  ).val();
...
function export_word_non_konstruksi(p1 = '') {
  ...
  $.redirect(
    url_export_word_non_konstruksi,
    {
      ID: ID,
      Posisi: Posisi,
      Nama_perusahaan1: Nama_perusahaan1,
