...
var table;
var url_list    = host + "pendidikan-list";
var url_edit    = host + "pendidikan-edit";
var url_delete  = host + "pendidikan-active";
var url_save    = host + "pendidikan-save";
var url_export  = host + "pendidikan-export";
var url_save_import = host + "pendidikan-save-import";
...
function save(p1){
    ...
    var pendidikan                  = $('.summernote_pendidikan').summernote('code');
    var pendidikan_non              = $('.summernote_pendidikan_non').summernote('code');
    var plainText_pendidikan        = $("<p>" + pendidikan+ "</p>").text();
    var plainText_pendidikan_non    = $("<p>" + pendidikan_non+ "</p>").text();

    xform = '#form';
    $(xform+' [name=Pendidikan]').val(plainText_pendidikan);
    $(xform+' [name=Pendidikan_non_formal]').val(plainText_pendidikan_non);
...
function export_data(){
    ...
    $('.total_pengalaman').each(function(i,v){
        i= i+1;
        data_detail[i] = {
            Pendidikan                 : $('#Pendidikan' + i).val(),
            Pendidikan_non_formal      : $('#Pendidikan_non_formal' + i).val(),
            ...
            // Status_kepegawaian         : $('#Status_kepegawaian' + i).val(),
            Status_kepegawaian         : $('[name=Status_kepegawaian]:checked').val(),
