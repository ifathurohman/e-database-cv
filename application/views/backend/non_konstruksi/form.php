                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-custom" name="Surat_referensi[]" id="Surat_referensi1" type="text" placeholder="Masukan surat referensi dari pengguna jasa" value="Terlampir" readonly="">
                            </div>
                        </div>
                    </div>
                </div>
