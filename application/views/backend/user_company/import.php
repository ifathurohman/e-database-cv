    ...
    <div class="row form-import content-hide">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-lg-12">
                        <h4 class="card-title">1. Download Template <a href="<?= site_url('template-users') ?>" target="_blank">Here</a></h4>

                        <h4 class="card-title">2. Masukan Data Import</h4>
                        <ul class="list-icons">
                            <li class="m-0"><i class="ti-angle-right"></i> Name wajib di isi dan tidak boleh duplicate</li>
                            <li class="m-0"><i class="ti-angle-right"></i> Gender wajib di isi 'Male' atau 'Female'</li>
                            <li class="m-0"><i class="ti-angle-right"></i> Start Work Date opsional di isi dengan format 'yyyy-mm-dd'</li>
                            <li class="m-0"><i class="ti-angle-right"></i> Iso Country wajib di isi </li>
                            <li class="m-0"><i class="ti-angle-right"></i> Phone Number wajib di isi </li>
                            <li class="m-0"><i class="ti-angle-right"></i> Work Pattern wajib di isi </li>
                            <li class="m-0"><i class="ti-angle-right"></i> Parent user opsional </li>
                            <li class="m-0"><i class="ti-angle-right"></i> Username wajib di isi dan tidak boleh duplicate</li>
                            <li class="m-0"><i class="ti-angle-right"></i> Role wajib di isi sesuai nama yang sudah terdaftar</li>
                            <li class="m-0"><i class="ti-angle-right"></i> Imei wajib di isi ketika 'Mandatory Imei Yes'</li>
                            <li class="m-0"><i class="ti-angle-right"></i> Mandatory Imei wajib di isi 'Yes' atau 'No'</li>
                            <li class="m-0"><i class="ti-angle-right"></i> Branch wajib di isi sesuai nama yang sudah terdaftar</li>
                        </ul>
