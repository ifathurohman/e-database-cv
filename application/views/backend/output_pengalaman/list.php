...
<div class="row list-view" style="margin-top: 5px;">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <!-- <?php $this->load->view($filter); ?> -->
                <table id="table-list-uraian" class="tablesaw table-bordered table-hover table-cursor table table-responsive-lg dataTables-Normal" style="width:100% !important">
                    <thead>
                        <tr>
                            <th width="80">
