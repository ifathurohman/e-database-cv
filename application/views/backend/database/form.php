<form id="form-import" autocomplete="off">
    ...
    <div class="row" style="margin-top: 2%;">
                    ...
                    <div class="row page-data list" data-url="<?= $url ?>" data-module="<?= $module ?>">
                        ...
                        <!-- <div class="col-md-3">
                            ...
                            <h5 class="card-title pull-right">Unduh Tamplate
                                <a href="<?= site_url('database-template') ?>" target="_blank">Disini</a>
                            </h5>
                        </div> -->
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="row guide_hide">
                                <div class="col-lg-12">
                                    <h4 class="card-title">1. Download Template <a href="<?= site_url('database-template') ?>" target="_blank">Disini</a></h4>
        ...
        <div class="col-md-12 v-import-result">
            <div class="card">
                <div class="card-header bt-light-grey">
                    <h4 class="m-b-0 text-muted-bold">HASIL UPLOAD DATABASE</h4>
                </div>
...
<!-- Files Upload -->
<link href="<?= base_url('assets/file_upload/database.css" rel="stylesheet') ?>">
