...
<body class="skin-default fixed-layout">
    ...
    <div id="main-wrapper">
        ...
        <footer class="footer text-center">
            ...
            Copyright © 2021 - Ciriajasa Engineering & Management Consultant. Hak Cipta Dilindungi Undang-Undang (<span style='text-decoration: underline;'><?= $this->main->version_js() ?></span>)
        </footer>
        <!-- End footer -->
    </div>
    <!-- End Wrapper -->
