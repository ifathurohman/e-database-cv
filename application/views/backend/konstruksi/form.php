...
<form id="form" name="form-konstruksi" autocomplete="off" data-id = "<?= $id ?>">
                ...
                <div class="card-body bg-card collapsed-target">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="col-md-8 Status_kepegawaian-view">
                                <div class="form-group">
                                    <label class="custom-label-2">STATUS KEPEGAWAIAN PADA PERUSAHAAN</label>
                                    <div class="row mobile-radio-groups radio-cols">
                                        <fieldset class="controls">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" name="Status_kepegawaian[]" id="status_kepeg1_tidak_tetap1" value="Tidak Tetap" class="form-check-input Status_kepegawaian Status_kepegawaian1 radio-custom">
                                                <label class="form-check-label label-custom1" style="margin-left:25px;">Tidak Tetap</label>
                                            </div>
                                        </fieldset>
                                        <fieldset class="controls">
                                            <div class="custom-control custom-radio ml-70-px">
                                                <input type="radio" name="Status_kepegawaian[]" id="status_kepeg1_tetap1" value="Tetap" class="form-check-input Status_kepegawaian Status_kepegawaian1 radio-custom">
