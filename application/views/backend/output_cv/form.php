...
<form id="form" name="form-konstruksi" autocomplete="off">
    ...
    <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group ml-13-px">
                                ...
                                <div id="Penguasaan_bahasa_indo" class="row">
            ...
            <div class="card">
                ...
                <div class="card-body bg-card">
                    ...
                    <div class="row">
                        <div class="col-md-8 Status_kepegawian2-view">
                            <div class="form-group">
                ...
                <div class="card">
                    ...
                    <div class="card-body bg-card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <P class="fw-500">Daftar riwayat hidup ini saya buat dengan sebenar-benarnya dan penuh rasa tanggung jawab. Jika terdapat pengungkapan keterangan yang tidak benar secara sengaja atau sepatutnya diduga maka saya siap untuk digugurkan dari proses seleksi atau dikeluarkan jika sudah dipekerjakan.</P>
                                </div>
                                <div class="form-group">
                                    <div class="controls">
                                        <div class="form-check">
                                            <input type="checkbox" required="" value="1" class="form-check-input" name="Pernyataan" id="Pernyataan" style="width: 20px;height: 20px;">
                        ...
                        <div class="button-group">
                            ...
                            <button type="button" class="btn waves-effect waves-light btn-custom btn-ekspor" onclick="export_word_konstruksi()">EKSPOR KE WORD</button>
                            <button type="button" class="btn waves-effect waves-light btn-custom btn-simpan" onclick="update_konstruksi()">SIMPAN</button>
                        </div>
                    </div>
                </div>
            </div>

            <div id="pernyataan_non_konstruksi">
                <div class="card">
                    <div class="card-header bt-light-grey">
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <div class="card-body bg-card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        <div class="form-check">
                                            <input type="checkbox" required="" value="1" class="form-check-input" name="Pernyataan" id="Pernyataan_non" style="width: 20px;height: 20px;">
                                            <label class="form-check-label label-custom1" style="margin-left:25px;">Saya Setuju</label>
                                        </div>
                                    <div class="help-block"></div></div>
                                </div>
                        ...
                        <div class="button-group">
                            <button type="button" class="btn waves-effect waves-light btn-custom btn-batal" onclick="batal()">BATAL</button>
                            <button type="button" class="btn waves-effect waves-light btn-custom btn-ekspor" onclick="export_word_non_konstruksi()">EKSPOR KE WORD</button>
                            <button type="button" class="btn waves-effect waves-light btn-custom btn-simpan" onclick="update_non_konstruksi()">SIMPAN</button>
                        </div>
                    </div>
                </div>
            </div>
