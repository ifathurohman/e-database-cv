    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body v-table-non-konstruksi">
                <?php $this->load->view($filter); ?>
                <table id="table-list-non" class="tablesaw table-bordered table-hover table-cursor table table-responsive-lg" style="width:100% !important">
                    <thead>
                        <tr>
                            <th width="120">
            ...
            <div class="card-header">
                <div class="row page-data list" data-url="<?= $url ?>" data-module="<?= $module ?>">
                    ...
                    <div class="col-md-3 align-self-center text-right">
                        ...
                        <a id="print" target="_blank" class="print"><img class="margin-right" width="42" src="<?= base_url('img/icon/fluent_print-20-filled.png')?>"></a>
