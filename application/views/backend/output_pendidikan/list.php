            ...
            <div class="card-header">
                <div class="row page-data list" data-url="<?= $url ?>" data-module="<?= $module ?>">
                    <div class="col-md-9 align-self-center">
                        <h4 class="form-text v-list">CARI OUTPUT BIODATA TENAGA AHLI BERDASARKAN KATEGORI INPUT</h4>
                    </div>
...
<!-- <script src="<?= base_url('asset/js/custom/backend/output_pendidikan.js') ?>"></script> -->

<script src="<?= base_url('asset/js/custom/backend/output_pendidikan.js').$this->main->version_js() ?>"></script>
