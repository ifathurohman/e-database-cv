                            ...
                            <div class="wrapper-posisi">
                                <form action="javascript::void(0)">
                                    ...
                                    <div class="upload-btn-wrapper">
                                        ...
                                        <input class="file-input-posisi" type="file" name="file_riwayat" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                                    </div>
                                </form>
                            </div>
                        </div>
