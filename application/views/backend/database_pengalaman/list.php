...
<!-- <script src="<?= base_url('asset/js/custom/backend/database_pengalaman.js') ?>"></script> -->

<script src="<?= base_url('asset/js/custom/backend/database_pengalaman.js').$this->main->version_js() ?>"></script>
