<form id="form-import" autocomplete="off">
    ...
    <div class="row" style="margin-top: 2%;">
        <div class="col-12">
            <div class="card">
                <div class="card-header bt-light-grey">
                    <div class="row page-data list" data-url="<?= $url ?>" data-module="<?= $module ?>">
                        <div class="col-md-9 align-self-center">
                            <h4 class="m-b-0 text-muted-bold">UPLOAD DATABASE</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body bg-card">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="wrapper-posisi file-upload-container">
                                <form action="javascript::void(0)">
                                    ...
                                    <div class="upload-btn-wrapper">
                                        ...
                                        <input class="file-input-riwayat" type="file" name="file_riwayat" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="row guide_hide2">
                                <div class="col-lg-12">
                                    <h4 class="card-title">1. Download Template <a href="<?= site_url('database_riwayat-template') ?>" target="_blank">Disini</a></h4>

                                    <h4 class="card-title">2. Masukan Data Import</h4>
                                    <ul class="list-icons">
                                        <li class="m-0" ><i class="ti-angle-right"></i> Posisi yang diusulkan wajib di isi</li>
                                        <li class="m-0" ><i class="ti-angle-right"></i> Nama perusahaan wajib di isi</li>
                                        <li class="m-0" ><i class="ti-angle-right"></i> Nama personil wajib di isi</li>
                                        <li class="m-0" ><i class="ti-angle-right"></i> Tempat tanggal lahir wajib di isi</li>
                                        <li class="m-0" ><i class="ti-angle-right"></i> Pendidikan wajib di isi</li>
                                        <li class="m-0" ><i class="ti-angle-right"></i> Pendidikan non formal wajib di isi</li>
                                        ...
                                        <li class="m-0"><i class="ti-angle-right"></i> Posisi Penugasan wajib di isi</li>
                                        <li class="m-0"><i class="ti-angle-right"></i> Uraian Tugas wajib di isi</li>
                                        <li class="m-0" style="font-weight: bold;font-size:18px;font-style: italic;color: red;"><i class="ti-angle-right"></i>  Di Akhir Kalimat Uraian Tugas Tambahkan <span style="color: red;font-size: 30px;"> ; </span></li>
                                    </ul>
                                    <div class="boder" style="padding: 20px;">
                            ...
                            <section class="progress-area2">
                            </section>
                            <section class="upload-area2">
                            </section>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-12 v-import-result">
            <div class="card">
                <div class="card-header bt-light-grey">
                    <h4 class="m-b-0 text-muted-bold">HASIL UPLOAD DATABASE DAFTAR RIWAYAT</h4>
                </div>
        ...
        <div class="col-md-12 v-import-result2">
            <div class="card">
                <div class="card-header bt-light-grey">
                ...
                <div class="card-body table-responsive">
                    ...
                    <table id="table-import-result2" class="tablesaw table-bordered table">
                        <thead></thead>
                        <tbody></tbody>
                    </table>
                    <input type="hidden" name="CompanyID" id="CompanyID">
                    <div class="card-button">
                        <div class="card-body">
                            <div class="button-group action-buttons">
                                <button type="button" class="btn waves-effect waves-light btn-custom btn-batal" onclick="batal()">BATAL</button>
                                <!-- <button type="button" class="btn waves-effect waves-light btn-custom btn-ekspor" onclick="export_data()">EKSPOR KE WORD</button> -->
                                <button type="button" class="btn waves-effect waves-light btn-custom btn-simpan" onclick="import_data2('save')">SIMPAN</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Files Upload -->
<link href="<?= base_url('assets/file_upload/posisi.css" rel="stylesheet') ?>">
<script src="<?= base_url('assets/file_upload/upload_database.js') ?>"></script>
