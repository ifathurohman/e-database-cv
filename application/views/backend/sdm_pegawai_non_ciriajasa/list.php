...
<!-- Modal -->
<?php $this->load->view('backend/modal/modal_daftar_pegawai') ?>
<!-- Modal -->
...
<!-- <script src="<?= base_url('asset/js/custom/backend/sdm_non_ciriajasa.js') ?>"></script> -->

<script src="<?= base_url('asset/js/custom/backend/sdm_non_ciriajasa.js').$this->main->version_js() ?>"></script>
