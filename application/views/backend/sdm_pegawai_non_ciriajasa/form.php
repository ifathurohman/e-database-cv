...
<div class="row page-titles page-data" data-url="<?= $url ?>" data-module="<?= $module ?>">
    <div class="col-md-8 align-self-center">
        <h4 class="form-text">FORM INPUT DAFTAR SDM PEGAWAI NON PT CIRIAJASA EC</h4>
                    ...
                    <div class="row">
                        <div class="col-md-8 order-2 order-md-1">
                            <div class="form-group">
                                ...
                                <input class="form-control input-custom Nama" name="Nama" type="text" onclick="modal_daftar_pegawai('.Nama')" placeholder="Masukan nama" >
