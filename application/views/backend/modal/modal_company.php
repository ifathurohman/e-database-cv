<div id="modal-company" class="modal modal-primary fade modal-fade-in-scale-up in" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-12">
            <table id="table-modal-company" class="tablesaw table-bordered table-hover table-cursor table full-width">
              <thead>
                <tr>
