<div id="modal-daftar-pegawai-ciriajasa" class="modal modal-primary fade modal-fade-in-scale-up in" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog">
  <div class="modal-dialog modal-lg-custom ">
    <div class="modal-content">
      <div class="modal-header">
        <div class="row col-lg-12">
          <div class="col-lg-9 align-self-center">
              <h4 class="modal-title" style="font-weight: bold">DAFTAR SDM PEGAWAI PT CIRIAJASA EC</h4>
          </div>
                  ...
                  <div class="col-md-12">
                      <div class="form-group mb-0">
                          <div class="input-group">
                              <input type="text" name="f-Search" placeholder='Cari' class="form-control f-Search" onkeyup="modal_daftar_pegawai_ciriajasa_filter(event)" style="line-height: 2.5 !important;">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-12">
            <table id="table-modal-daftar-pegawai-ciriajasa" class="table table-hover no-wrap" style="width:100%;">
...
<script src="<?= base_url('asset/js/custom/backend/daftar_pegawai_ciriajasa_modal.js').$this->main->version_js() ?>"></script>
