                  ...
                  <div class="row g-0">
                    <div class="col-6 col-md-4">
                      <!-- <div class="card border"> -->
                        <div class='card-body desktop-divider-right mobile-plr-0'>
                          <div class="row align-items-center">
                            <div class="col-5"><img class="img-circle" alt="user" src="<?= base_url('img/icon/01.png')?>"></div>
                            <div class="col-7">
                                  <div class="font-medium mobile-font-size">Terkontrak</div>
                    ...
                    <div class="col-6 col-md-4">
                      <!-- <div class="card border"> -->
                        <div class='card-body desktop-divider-right mobile-plr-0'>
                          <div class="row align-items-center">
                            <div class="col-5"><img class="img-circle" alt="user" src="<?= base_url('img/icon/02.png')?>"></div>
                            <div class="col-7">
                                  <div class="font-medium mobile-font-size">Tersedia</div>
                    ...
                    <div class="col-6 offset-3 col-md-4 offset-md-0">
                      <!-- <div class="card border"> -->
                      <div class=''>
                          <div class="card-body row align-items-center mobile-plr-0">
                            <div class="col-5"><img class="img-circle" alt="user" src="<?= base_url('img/icon/03.png')?>"></div>
                            <div class="col-7">
                                  <div class="font-medium mobile-font-size">Tender</div>
