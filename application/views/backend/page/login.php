...
<body class="skin-default card-no-border">
    ...
    <div class="login-box margin-right-230">
        <div class="card-body margin-top-17">    
            <form class="text-center" id="loginform">
                <img width="250px" src="<?= base_url('img/icon/digital-E-Database-CV.png'); ?>"/><br>
                <img width="180px" style="margin-top:20px;" src="<?= base_url('img/icon/Login-to-continue.png'); ?>"/><br>
            ...
            <form id="recoverform" style="margin-top:45%;">
                <div class="form-group ">
                    <div class="col-xs-12">
                        <h2 class="box-title m-t-40 m-b-0" style="font-weight:700">Reset Passsword</h2>
                        <p style="font-size: 10pt; color:darkgray;margin-top: 15px;margin-bottom: 30px;">Enter the email associated with your account and we'll send you an email with instructions to reset your password </p>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
            ...
            <form id="registerform" style="margin-top:-15%;">
                <h1 class="box-title m-t-40 m-b-0" style="font-weight:700">Sign Up</h1><h4 style=" font-size: large;font-weight: 100;color: darkgray;margin-top: 10px;margin-bottom: 20px;">Register to continue</h4>
        ...
        <div class='login-logo-custom-container'>
            <img class="logo-custom logo" src="<?= base_url('img/icon/ciriajasa-1.png') ?>"><br>
        </div>
        <img class="image1-custom" id="img-log" src="<?= base_url('img/icon/output-onlinegiftools.gif') ?>"><br>
        <img class="image2-custom register-image" id="img-reg" src="<?= base_url('img/icon/illustration-regis-01.png') ?>"><br>
        <img class="image3-custom reset-image" id="img-for" src="<?= base_url('img/icon/forgot-password-1.png') ?>"><br>
