	        ...
	        foreach ($period as $dt) {
	            ...
	            foreach ($list as $k2 => $v2) {
	            	if($v2->EmployeeID == $v->EmployeeID && $date == $v2->WorkDate):
	            		...
	            		$item_dt2 .= '<td>'.$v2->CheckIn.'</td>';
	            		$item_dt2 .= '<td>'.$v2->CheckOut.'</td>';
	            		$item_dt2 .= '<td>'.$v2->BreakStart.'</td>';
	            		$item_dt2 .= '<td>'.$v2->BreakEnd.'</td>';
	            		$item_dt2 .= '<td>'.$v2->OvertimeIn.'</td>';
	            		$item_dt2 .= '<td>'.$v2->OvertimeOut.'</td>';
	            	endif;
	            }
