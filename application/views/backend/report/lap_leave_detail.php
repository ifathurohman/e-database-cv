<table id="table" class="tablesaw table-bordered table table-responsive-lg mt-20" width="100%">
	<tr>
		...
		<th><?= $this->lang->line('lb_leave_type') ?></th>
		<th><?= $this->lang->line('lb_leave_start') ?></th>
		<th><?= $this->lang->line('lb_leave_end') ?></th>
	...
	if(count($list)>0):
		...
		echo $this->report->DataNotFound(14);
	endif;
	?>
</table>